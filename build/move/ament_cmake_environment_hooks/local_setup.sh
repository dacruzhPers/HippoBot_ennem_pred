...
: ${AMENT_CURRENT_PREFIX:="/home/danielaquabot/ros2_aquabot_ws/install/move"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/move/environment/pythonpath.sh"
